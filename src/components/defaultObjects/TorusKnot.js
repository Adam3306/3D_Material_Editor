...
class TorusKnot {
  constructor(name, radius, tube, radialSegments, tubularSegments, p, q, scene, pos = new BABYLON.Vector3(0, 0, 0)) {
    console.log("MyObj ctor");

    this.m_obj = BABYLON.Mesh.CreateTorusKnot(name, radius, tube, radialSegments, tubularSegments, p, q, scene, true, 3);
